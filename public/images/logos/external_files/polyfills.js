        ...
        var o = t(function (t, a) {
          ...
          u = function (t, e, r) {
            var n,
              ...
              u = a(t),
              c = s(t, e);
            return c ? (c.value = r) : ((u.last = c = { index: (o = $r(e, !0)), key: e, value: r, previous: (n = u.last), next: void 0, removed: !1 }), u.first || (u.first = c), n && (n.next = c), i ? u.size++ : t.size++, "F" !== o && (u.index[o] = c)), t;
          },
          s = function (t, e) {
            var r,
              n = a(t),
  ...
  (Ai || Ri || Oi) &&
    (xi = function (t) {
      var e,
        ...
        f = t;
      return (
        a && (-1 === (u = u.replace("y", "")).indexOf("g") && (u += "g"), (f = String(t).slice(i.lastIndex)), i.lastIndex > 0 && (!i.multiline || (i.multiline && "\n" !== t[i.lastIndex - 1])) && ((s = "(?: " + s + ")"), (f = " " + f), c++), (r = new RegExp("^(?:" + s + ")", u))),
        ...
        (n =
          "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
            ? function (t, r) {
                ...
                for (var i, a, u, s = [], c = 0, f = new RegExp(t.source, (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : "") + "g"); (i = ji.call(f, n)) && !((a = f.lastIndex) > c && (s.push(n.slice(c, i.index)), i.length > 1 && i.index < n.length && Xi.apply(s, i.slice(1)), (u = i[0].length), (c = a), s.length >= o)); )
        ...
        switch (((i = o[f]), c)) {
          ...
          case Oc:
            if (i == Ss || "/" == i || ("\\" == i && ec(t)) || (!r && ("?" == i || "#" == i))) {
              if (
                (".." === (s = (s = l).toLowerCase()) || "%2e." === s || ".%2e" === s || "%2e%2e" === s ? (ac(t), "/" == i || ("\\" == i && ec(t)) || t.path.push("")) : uc(l) ? "/" == i || ("\\" == i && ec(t)) || t.path.push("") : ("file" == t.scheme && !t.path.length && oc(l) && (t.host && (t.host = ""), (l = l.charAt(0) + ":")), t.path.push(l)),
                (l = ""),
