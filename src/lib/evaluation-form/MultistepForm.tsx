...
export default function MultistepForm({ className, multistepForm }: FormProps) {
  ...
  const { previousStep, nextStep, currentStepIndex, isFirstStep, isLastStep, steps, goTo, showSuccessMsg } = multistepForm;
